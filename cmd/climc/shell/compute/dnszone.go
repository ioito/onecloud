...
func init() {
	...
	R(&DnsZoneCapabilitiesOptions{}, "dns-zone-capability", "Show dns zone capabilities", func(s *mcclient.ClientSession, opts *DnsZoneCapabilitiesOptions) error {
		result, err := modules.DnsZones.Get(s, "capability", nil)
		if err != nil {
			return err
		}
		printObject(result)
