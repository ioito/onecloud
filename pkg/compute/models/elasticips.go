...
type SElasticip struct {
	...
	// IP地址
	IpAddr string `width:"17" charset:"ascii" list:"user" update:"user"`

	// 绑定资源类型
	AssociateType string `width:"32" charset:"ascii" list:"user" update:"user"`
	// 绑定资源Id
	AssociateId string `width:"256" charset:"ascii" list:"user" update:"user"`
